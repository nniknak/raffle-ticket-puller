...
Copy the relative path of that folder by right-clicking the folder and then holding the option key while the right-click menu is pulled up. This will reveal that option to "copy '[folder-name]' by as Pathname"
...
Follow the inputs! Get your results!
