...
Then, you'll need to have a folder with your exported venmo statement and this "raffle.py" in it. Rename your venmo statement file something nice like "venmo.csv".
